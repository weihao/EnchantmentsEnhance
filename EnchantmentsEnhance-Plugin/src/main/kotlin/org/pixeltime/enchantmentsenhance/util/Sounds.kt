...
enum class Sounds(private vararg val versionDependentNames: String) {
     ...
     */
    fun bukkitSound(): Sound {
        if (cached != null) return cached!!
        for (name in versionDependentNames) {
            try {
        ...
        throw IllegalArgumentException("Found no valid sound name for " + this.name)
    }
}
