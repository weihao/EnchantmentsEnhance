...
class LocaleManager {
    companion object {
        ...
        fun addLocale() {
            ...
            addLang("menu.lore.skip", arrayOf("&6Right click to &cskip &6 animation.", "&6右击&c跳过&6强化动画"))
            ...
            addLang("icon.gear1", arrayOf("Your current mode is gear enhancement.", "你当前的模式是装备强化"))
            addLang("icon.gear2", arrayOf("Click your weapons and armors to begin enhancement.", "你可以点击你武器和防具进行强化"))
