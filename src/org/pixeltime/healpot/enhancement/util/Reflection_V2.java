 ...
 */
public final class Reflection_V2 {
    ...
    private static String VERSION = OBC_PREFIX.replace("org.bukkit.craftbukkit",
        "").replace(".", "");
    // Variable replacement
    private static Pattern MATCH_VARIABLE = Pattern.compile("\\{([^\\}]+)\\}");


    private Reflection_V2() {
    }
    ...
    public static ConstructorInvoker getConstructor(
                    ...
                    public Object invoke(Object... arguments) {
                        try {
                            ...
                            throw new RuntimeException(
                                "Cannot invoke constructor " + constructor, e);
                        }
                    }
                };
            }
        ...
        throw new IllegalStateException(String.format(
            "Unable to find constructor for %s (%s).", clazz, Arrays.asList(
                params)));
    }
            ...
            if ((name == null || field.getName().equals(name)) && fieldType
                ...
                return new FieldAccessor<T>() {
                    ...
                    public boolean hasField(Object target) {
                        ...
                        return field.getDeclaringClass().isAssignableFrom(target
                            .getClass());
                    }
                };
            }
    ...
    public static MethodInvoker getTypedMethod(
        ...
        for (final Method method : clazz.getDeclaredMethods()) {
            if ((methodName == null || method.getName().equals(methodName))
                && (returnType == null) || method.getReturnType().equals(
                    returnType) && Arrays.equals(method.getParameterTypes(),
                        params)) {
        ...
        throw new IllegalStateException(String.format(
            "Unable to find method %s (%s).", methodName, Arrays.asList(
                params)));
    }
