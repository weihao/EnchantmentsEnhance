...
class LM {
    companion object {
        ...
        fun addLocale() {
            ...
            addLang("Menu.gui.remove", arrayOf("&6Deselect-Item", "&6取消"))
            ...
            addLang("enchantments.factory", arrayOf("&7Factory", "&7工厂"))
            ...
            addLang("enchantments.crushing", arrayOf("&7Crushing", "&7粉碎"))
            addLang("enchantments.curse", arrayOf("&7Curse", "&7诅咒"))
            addLang("enchantments.siphon", arrayOf("&7Siphon", "&7虹吸"))
            addLang("enchantments.demonic", arrayOf("&7Demonic", "&7恶灵"))
            ...
            addLang("enchantments.feather", arrayOf("&7Feather", "&7羽落"))
            addLang("enchantments.flame", arrayOf("&7Flame", "&7燃烧"))
            addLang("enchantments.haste", arrayOf("&7Haste", "&7急迫"))
            addLang("enchantments.shield", arrayOf("&7Shield", "&7生命护盾"))
            addLang("enchantments.hex", arrayOf("&7Hex", "&7巫术"))
            addLang("enchantments.holy_smite", arrayOf("&7Holy Smite", "&7圣水"))
            addLang("enchantments.rider", arrayOf("&7Rider", "&7骑御"))
            ...
            addLang("enchantments.suicide", arrayOf("&7Suicide", "&7帝陨"))
            ...
            addLang("enchantments.crits", arrayOf("&7Crits", "&7暴击"))
            addLang("enchantments.frosty", arrayOf("&7Frosty", "&7冰霜"))
            addLang("enchantments.invisible", arrayOf("&7Invisible", "&7隐身"))
            addLang("enchantments.vitality", arrayOf("&7Vitality", "&7元气"))
