...
class LM {
    companion object {
        ...
        fun addLocale() {
            ...
            LM.addLang("enchantments.lifesteal", arrayOf("&7Lifesteal", "&7吸血"))
            LM.addLang("enchantments.assassin", arrayOf("&7Assassin", "&7暗杀"))
            LM.addLang("enchantments.hex", arrayOf("&7Hex", "&7巫术"))
            LM.addLang("enchantments.jump", arrayOf("&7Jump", "&7跳跃"))
            LM.addLang("enchantments.speed", arrayOf("&7Speed", "&7神速"))
            LM.addLang("enchantments.zeus", arrayOf("&7Zeus", "&7雷鸣"))
            LM.addLang("enchantments.batvision", arrayOf("&7Batvision", "&7天眼"))
            LM.addLang("enchantments.demonic_aura", arrayOf("&7Demonic Aura", "&7恶灵"))
            LM.addLang("enchantments.dodge", arrayOf("&7Dodge", "&7闪避"))
            LM.addLang("enchantments.blessed", arrayOf("&7Blessed", "&7祝福"))
            LM.addLang("enchantments.curse", arrayOf("&7Curse", "&7诅咒"))
            LM.addLang("enchantments.crushing", arrayOf("&7Crushing", "&7暴击"))
            LM.addLang("enchantments.execute", arrayOf("&7Execute", "&7背刺"))
            LM.addLang("enchantments.stealth", arrayOf("&7Stealth", "&7潜伏"))
            LM.addLang("enchantments.aegis", arrayOf("&7Aegis", "&7庇护"))
            LM.addLang("enchantments.platemail", arrayOf("&7Platemail", "&7坚韧"))
            LM.addLang("enchantments.purge", arrayOf("&7Purge", "&7净化"))
            LM.addLang("enchantments.divine", arrayOf("&7Divine", "&7神圣"))
            LM.addLang("enchantments.entangle", arrayOf("&7Entangle", "&7绞杀"))
            LM.addLang("enchantments.pyromaniac", arrayOf("&7Pyromaniac", "&7火焰"))
            LM.addLang("enchantments.flame_cloak", arrayOf("&7Flame Cloak", "&7燃烧"))
            LM.addLang("enchantments.battlecry", arrayOf("&7Battlecry", "&7战吼"))
            LM.addLang("enchantments.corruption", arrayOf("&7Corruption", "&7腐败"))
            LM.addLang("enchantments.turmoil", arrayOf("&7Turmoil", "&7风暴"))
            LM.addLang("enchantments.holy_smite", arrayOf("&7Holy Smite", "&7圣水"))
            LM.addLang("enchantments.riftslayer", arrayOf("&7Riftslayer", "&7溅射"))
            LM.addLang("enchantments.petrify", arrayOf("&7Petrify", "&7石化"))
            LM.addLang("enchantments.eyepatch", arrayOf("&7Eyepatch", "&7天眼"))
            LM.addLang("enchantments.plunder", arrayOf("&7Plunder", "&7掠夺"))
            LM.addLang("enchantments.mischief", arrayOf("&7Mischief", "&7戏耍"))
            LM.addLang("enchantments.shadowstep", arrayOf("&7Shadowstep", "&7暗影步"))
            LM.addLang("enchantments.demon_siphon", arrayOf("&7Demon Siphon", "&7虹吸"))
            LM.addLang("enchantments.tamer", arrayOf("&7Tamer", "&7驯兽"))
            LM.addLang("enchantments.wolves", arrayOf("&7Wolves", "&7野狼"))
            LM.addLang("enchantments.disarm", arrayOf("&7Disarm", "&7缴械"))
            LM.addLang("enchantments.repel", arrayOf("&7Repel", "&7超人"))
            LM.addLang("enchantments.spiked", arrayOf("&7Spiked", "&7尖刺"))
            LM.addLang("enchantments.medic", arrayOf("&7Medic", "&7军医"))
            LM.addLang("enchantments.swimmer", arrayOf("&7Swimmer", "&7亲水"))
            LM.addLang("enchantments.thief", arrayOf("&7Thief", "&7盗窃"))
            LM.addLang("enchantments.health_boost", arrayOf("&7Health Boost", "&7生命护盾"))
            LM.addLang("enchantments.reborn", arrayOf("&7Reborn", "&7重生"))
            LM.addLang("enchantments.endless", arrayOf("&7Endless", "&7无尽"))
            LM.addLang("enchantments.molten", arrayOf("&7Molten", "&7炉融"))
            LM.addLang("enchantments.immolation", arrayOf("&7Immolation", "&7自焚"))
            LM.addLang("enchantments.strength", arrayOf("&7Strength", "&7力量"))
            LM.addLang("enchantments.horse_rider", arrayOf("&7Horse Rider", "&7骑御"))
            LM.addLang("enchantments.web_trap", arrayOf("&7Web Trap", "&7蛛网"))
            LM.addLang("enchantments.paralyze", arrayOf("&7Paralyze", "&7麻痹"))
            LM.addLang("enchantments.tnt_shooter", arrayOf("&7Tnt Shooter", "&7炮手"))
            LM.addLang("enchantments.rekt", arrayOf("&7Rekt", "&7碾压"))
            LM.addLang("enchantments.reversal", arrayOf("&7Reversal", "&7倒转"))
            LM.addLang("enchantments.reinforced", arrayOf("&7Reinforced", "&7钢筋"))
            LM.addLang("enchantments.wild_mark", arrayOf("&7Wild Mark", "&7野性印记"))
            LM.addLang("enchantments.shearer", arrayOf("&7Shearer", "&7剪裁"))
            LM.addLang("enchantments.farmer", arrayOf("&7Farmer", "&7农场"))
            LM.addLang("enchantments.haste", arrayOf("&7Haste", "&7急迫"))
            LM.addLang("enchantments.explosive", arrayOf("&7Explosive", "&7爆炸"))
            LM.addLang("enchantments.lumberjack", arrayOf("&7Lumberjack", "&7伐木"))
            LM.addLang("enchantments.plow", arrayOf("&7Plow", "&7耕种"))
            LM.addLang("enchantments.smelt", arrayOf("&7Smelt", "&7冶炼"))
            LM.addLang("enchantments.auto_block", arrayOf("&7Auto Block", "&7自动"))
            LM.addLang("enchantments.shooter", arrayOf("&7Shooter", "&7射手"))
            LM.addLang("enchantments.feather_fall", arrayOf("&7Feather Fall", "&7羽落"))
            LM.addLang("enchantments.suicide", arrayOf("&7Suicide", "&帝陨"))
            LM.addLang("enchantments.launch", arrayOf("&7Launch", "&7弹射"))
