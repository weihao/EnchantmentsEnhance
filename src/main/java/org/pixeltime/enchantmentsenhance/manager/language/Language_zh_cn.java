...
public class Language_zh_cn {
    ...
    public static void addLang() {
        ...
        SettingsManager.lang.addDefault("enchantments.lifesteal", "&7吸血");
        SettingsManager.lang.addDefault("enchantments.block", "&7格挡");
        SettingsManager.lang.addDefault("enchantments.assassin", "&7暗杀");
        SettingsManager.lang.addDefault("enchantments.kill_confirm", "&7杀戮");
        SettingsManager.lang.addDefault("enchantments.hex", "&7巫术");
        SettingsManager.lang.addDefault("enchantments.jump", "&7跳跃");
        SettingsManager.lang.addDefault("enchantments.speed", "&7神速");
        SettingsManager.lang.addDefault("enchantments.zeus", "&7雷鸣");
        SettingsManager.lang.addDefault("enchantments.enrage", "&7暴怒");
        SettingsManager.lang.addDefault("enchantments.batvision", "&7天眼");
        SettingsManager.lang.addDefault("enchantments.demonic_aura", "&7恶灵");
        SettingsManager.lang.addDefault("enchantments.dodge", "&7闪避");
        SettingsManager.lang.addDefault("enchantments.blessed", "&7祝福");
        SettingsManager.lang.addDefault("enchantments.arrow_rain", "&7箭雨");
        SettingsManager.lang.addDefault("enchantments.snare", "&7缓慢");
        SettingsManager.lang.addDefault("enchantments.curse", "&7诅咒");
        SettingsManager.lang.addDefault("enchantments.crushing", "&7暴击");
        SettingsManager.lang.addDefault("enchantments.execute", "&7背刺");
        SettingsManager.lang.addDefault("enchantments.stealth", "&7潜伏");
        SettingsManager.lang.addDefault("enchantments.aegis", "&7庇护");
        SettingsManager.lang.addDefault("enchantments.platemail", "&7坚韧");
        SettingsManager.lang.addDefault("enchantments.purge", "&7净化");
        SettingsManager.lang.addDefault("enchantments.divine", "&7神圣");
        SettingsManager.lang.addDefault("enchantments.entangle", "&7绞杀");
        SettingsManager.lang.addDefault("enchantments.pyromaniac", "&7火焰");
        SettingsManager.lang.addDefault("enchantments.flame_cloak", "&7燃烧");
        SettingsManager.lang.addDefault("enchantments.battlecry", "&7战吼");
        SettingsManager.lang.addDefault("enchantments.corruption", "&7腐败");
        SettingsManager.lang.addDefault("enchantments.turmoil", "&7风暴");
        SettingsManager.lang.addDefault("enchantments.holy_smite", "&7圣水");
        SettingsManager.lang.addDefault("enchantments.riftslayer", "&7溅射");
        SettingsManager.lang.addDefault("enchantments.petrify", "&7石化");
        SettingsManager.lang.addDefault("enchantments.eyepatch", "&7天眼");
        SettingsManager.lang.addDefault("enchantments.plunder", "&7掠夺");
        SettingsManager.lang.addDefault("enchantments.mischief", "&7戏耍");
        SettingsManager.lang.addDefault("enchantments.shadowstep", "&7暗影步");
        SettingsManager.lang.addDefault("enchantments.demon_siphon", "&7虹吸");
        SettingsManager.lang.addDefault("enchantments.animal_tamer", "&7驯兽");
        SettingsManager.lang.addDefault("enchantments.wolves", "&7野狼");
        SettingsManager.lang.addDefault("enchantments.disarm", "&7缴械");
        SettingsManager.lang.addDefault("enchantments.superman_punch", "&7超人");
        SettingsManager.lang.addDefault("enchantments.spiked", "&7尖刺");
        SettingsManager.lang.addDefault("enchantments.medic", "&7军医");
        SettingsManager.lang.addDefault("enchantments.swimmer", "&7亲水");
        SettingsManager.lang.addDefault("enchantments.thief", "&7盗窃");
        SettingsManager.lang.addDefault("enchantments.health_boost", "&7生命护盾");
        SettingsManager.lang.addDefault("enchantments.reborn", "&7重生");
        SettingsManager.lang.addDefault("enchantments.endless", "&7无尽");
        SettingsManager.lang.addDefault("enchantments.molten", "&7炉融");
        SettingsManager.lang.addDefault("enchantments.immolation", "&7自焚");
        SettingsManager.lang.addDefault("enchantments.strength", "&7力量");
        SettingsManager.lang.addDefault("enchantments.horse_rider", "&7骑御");
        SettingsManager.lang.addDefault("enchantments.web_trap", "&7蛛网");
        SettingsManager.lang.addDefault("enchantments.paralyze", "&7麻痹");
        SettingsManager.lang.addDefault("enchantments.soft_touch", "&7柔顺");
        SettingsManager.lang.addDefault("enchantments.tnt_shooter", "&7炮手");
        SettingsManager.lang.addDefault("enchantments.rekt", "&7碾压");
        SettingsManager.lang.addDefault("enchantments.reversal", "&7倒转");
        SettingsManager.lang.addDefault("enchantments.reinforced", "&7钢筋");
        SettingsManager.lang.addDefault("enchantments.wild_mark", "&7野性印记");
        SettingsManager.lang.addDefault("enchantments.shearer", "&7剪裁");
        SettingsManager.lang.addDefault("enchantments.farmer", "&7农场");
        SettingsManager.lang.addDefault("enchantments.haste", "&7急迫");
        SettingsManager.lang.addDefault("enchantments.explosive", "&7爆炸");
        SettingsManager.lang.addDefault("enchantments.lumberjack", "&7伐木");
        SettingsManager.lang.addDefault("enchantments.plow", "&7耕种");
        SettingsManager.lang.addDefault("enchantments.smelt", "&7冶炼");
        SettingsManager.lang.addDefault("enchantments.auto_block", "&7自动");
        SettingsManager.lang.addDefault("enchantments.shooter", "&7射手");
        SettingsManager.lang.addDefault("enchantments.feather_fall", "&7羽落");
        SettingsManager.lang.addDefault("enchantments.suicide", "&帝陨");
        SettingsManager.lang.addDefault("enchantments.angry_birds", "&7弹射");
