...
public class Demonic_Aura implements Listener {
    ...
    public void onDamage(final EntityDamageByEntityEvent entityDamageByEntityEvent) {
        final String translateAlternateColorCodes = ChatColor.translateAlternateColorCodes('&', SettingsManager.lang.getString("enchantments." + "demonic_aura"));
        if (entityDamageByEntityEvent.getDamager() instanceof Player && entityDamageByEntityEvent.getEntity() instanceof Player) {
            try {
                ...
                ItemStack[] array5;
                for (int length5 = (array5 = armorContents).length, n = 0; n < length5; ++n) {
                    final ItemStack itemStack5 = array5[n];
